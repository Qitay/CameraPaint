		...
		if (contourArea(contours[i]) >= 5000)
		{
			...
			if (hullsI[0].size()>0)
			{
				...
				if (defects.size() >= 3)
				{
					...
					{
					case 1:
						hand_cascade.detectMultiScale(frame, hands, 1.1, 2, 0 | CV_HAAR_FIND_BIGGEST_OBJECT, Size(50, 50), Size(300, 300));
						break;
					case 2:
						hand_cascade2.detectMultiScale(frame, hands, 1.1, 2, 0 | CV_HAAR_FIND_BIGGEST_OBJECT, Size(50, 50), Size(300, 300));
						break;
					case 3:
						hand_cascade3.detectMultiScale(frame, hands, 1.1, 2, 0 | CV_HAAR_FIND_BIGGEST_OBJECT, Size(50, 50), Size(300, 300));
						break;
					case 4:
						hand_cascade3.detectMultiScale(frame, hands, 1.1, 2, 0 | CV_HAAR_FIND_BIGGEST_OBJECT, Size(50, 50), Size(300, 300));
						break;
					case 5:
						face_cascade.detectMultiScale(frame, hands, 1.1, 2, 0 | CV_HAAR_FIND_BIGGEST_OBJECT, Size(50, 50), Size(400, 400));
						break;
					}
